			...
			<div class="collapsed navbar-collapse" id="bs-example-navbar-collapse-2">
				<ul class="nav navbar-nav">
					<li><a href="<?php echo URL; ?>">Inicio</a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Estudiante</a>
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Seccion</a>
						<ul class="dropdown-menu" role="menu">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="www.youtube.com">Videos del programa</a></li>
				</ul>
			</div>
		</div>	
		</nav>
